...
c(true, { nombre: 'pepita'}, "soy string");

function hola(){
  console.log('Saludos desde la funcion hola');
}
...
function h(){
  return function otroHola(){
    console.log('Hola desde funcion retornada');
  }
}

// otroHola(); No funciona
...
// Una función de orden superior es aquella que recibe y/o
...
personajes.forEach(function (personaje, index){
  ...
  console.log('forEach', personaje.name);
});